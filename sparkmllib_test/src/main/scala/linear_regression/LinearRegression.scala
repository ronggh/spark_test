...
object LinearRegression {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //加载数据样本
    val path = "f://MyProject/spark_test/in_data/linear_regression_data.txt";
    ...
    //保存模型
    model.save(sc, "f://MyProject/spark_test/out_data/scalaLinearRegressionWithSGDModel")
    //重新加载模型
    val sameModel = LinearRegressionModel.load(sc, "f://MyProject/spark_test/out_data/scalaLinearRegressionWithSGDModel")
